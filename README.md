...
- Търсене в широчина (Breadth-First Search) - изследва всички съседни състояния на текущото състояние, преди да премине към следващото ниво.
- Търсене в дълбочина (Depth-First Search) - изследва пътя до най-дълбокото състояние, преди да се върне назад и да продължи с други непроверени пътища.
- Евристично търсене (Heuristic Search) - използва евристика или оценка на разстоянието до целевото състояние, за да определи най-обещаващия път.
- Алгоритъм A* (A* Algorithm) - комбинира търсене в широчина с евристично търсене, за да намери най-ефективния път до целта.
- Итеративно задълбочаващо търсене (Iterative Deepening Search) - комбинира предимствата на търсенето в широчина и търсенето в дълбочина, като изследва състоянията с нарастваща дълбочина.
