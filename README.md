...
- FPM - Метод на функционалните точки. Олбрихт през 1979. Идеята на този метод е, че усилията и цената в разработката на даден софтуер се определят от неговата функционалност използвайки функционални точки.
